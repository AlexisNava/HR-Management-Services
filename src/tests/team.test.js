...
describe('Team', () => {
  ...
  it('GET /api/team/employees should reponds Unauthorized when the request doesnt have the Authorization header', async () => {
    const { statusCode, body } = await request(app).get('/api/team/employees');
